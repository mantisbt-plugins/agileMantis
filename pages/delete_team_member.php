<?php 
	...
	$username = $team->getUserRealName($_POST['user_id']);
...
?>
	...
	<div align="center">
		<hr width="50%">
			<?php echo plugin_lang_get( 'remove_member_messageA' )?> <?php echo $rolename?> <?php echo plugin_lang_get( 'remove_member_messageB' )?><br>
			...
			<form action="<?php echo plugin_page('edit_team.php') ?>" method="post">
				...
				<input type="submit" name="deleteTeamMember" value="<?php echo plugin_lang_get( 'remove_member_title' )?>" class="button">
