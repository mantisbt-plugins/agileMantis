...
<?php
		...
		function createTableView($id, $username, $realname, $email, $participant, $developer, $administrator, $expert){
			...
			return '<tr '. helper_alternate_class() .'>
					...
					<td><b>'.$realname.'</b></td>
					<td><b>'.$email.'</b></td>
					<td class="center"><input type="checkbox" name="participant['.$id.']" value="1" '.$participant_check.' '.$participant_disable.'></td>
					'.$additional.'
		...
		<table align="center" class="width75" cellspacing="1">
			<tr>
				<td><a href="<?php echo plugin_page("agileuser.php")?>"><?php echo plugin_lang_get( 'manage_user_show_all' )?></a></td>
		...
		<table align="center" class="width100" cellspacing="1">
			...
			<tr>
				...
				<td class="category"><b><a href="<?php echo plugin_page("agileuser.php")?>&sort_by=realname"><?php echo plugin_lang_get( 'manage_user_realname' )?></a></b></td>
				<td class="category"><b><a href="<?php echo plugin_page("agileuser.php")?>&sort_by=email">Email</a></b></td>
...
?>
		<br>
			<center><span style="color:red; font-size:16px; font-weight:bold;"><?php echo plugin_lang_get( 'manage_user_error_921A00' )?></span></center>
<?php
	}
?>
