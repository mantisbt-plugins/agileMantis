<?php 
	...
	if($_POST['submit'] == plugin_lang_get( 'button_back' )) {
		header($au->forwardReturnToPage('agileuser.php'));
	}
	if($_POST['action'] == 'addUser'){
		...
		$au->setAgileMantisUserRights($t_user_id, $_POST['participant'], $_POST['developer'], $_POST['administrator']);
...
<br>
<div align="center">
<form method="post" action="<?php echo plugin_page("add_user.php")?>" method="post">
...
<tr>
	<td class="center" colspan="2">
		...
		<input type="submit" class="button" name="submit" value="<?php echo plugin_lang_get( 'button_back' ) ?>" />
	</td>
</tr>
</table>
</form>
</div>
<?php } else {echo '<br><center><span style="color:red;font-size:16px;font-weight:bold;">'.plugin_lang_get( 'info_error_921001' ).'</span></center>';}?>
