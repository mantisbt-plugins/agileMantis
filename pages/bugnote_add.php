...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	if($f_task_id > 0){
		print_successful_redirect(plugin_page('edit_task.php&tid='.$f_task_id, true));
	} else {
		print_successful_redirect(plugin_page('task_page.php&us_id='.$f_bug_id, true));
	}
