...
# along with agileMantis. If not, see <http://www.gnu.org/licenses/>.
	...
	echo '<us_summary><![CDATA['.$userstory[0]['summary'].']]></us_summary>';
	echo '<us_status>'.$userstory[0]['status'].'</us_status>';
	echo '<us_description><![CDATA['.$userstory[0]['description'].']]></us_description>';
	...
	echo '<version>';
		echo '<us_version_project><![CDATA['.$agilemantis_project->getProjectName($userstory[0]['project_id']).']]></us_version_project>';
	...
	if(!empty($temp_tasks)){
		...
		foreach($temp_tasks AS $num => $row){
			...
			echo '<task>';
				...
				echo '<task_name><![CDATA['.$row['name'].']]></task_name>';
				echo '<task_description><![CDATA['.$row['description'].']]></task_description>';
	...
	if(!empty($notices)){
		...
		foreach($notices AS $num => $row){
			echo '<notice>';
				...
				echo '<note_description><![CDATA['.$row['note'].']]></note_description>';
